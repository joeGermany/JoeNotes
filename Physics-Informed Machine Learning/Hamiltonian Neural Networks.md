...
$L = \left\lVert \dfrac{\partial \hat{\mathcal{H}}}{\partial \mathbf{p}} - \dfrac{d \mathbf{q}}{d t} \right\rVert ^2 + \left\lVert \dfrac{\partial \hat{\mathcal{H}}}{\partial \mathbf{q}} + \dfrac{d \mathbf{p}}{d t} \right\rVert ^2,$
